...
boxes = [
    (60, 80, 0, 100),     # Box 0   (3, 0)
    (60, 80, 100, 200),   # Box 1   (3, 1)
    (60, 80, 200, 300),   # Box 2   (3, 2)
    (120, 140, 0, 100),   # Box 3   (6, 0)
    (120, 140, 100, 200), # Box 4   (6, 1)
    (120, 140, 200, 300), # Box 5   (6, 2)
    (180, 200, 0, 100),   # Box 6   (9, 0)
    (180, 200, 100, 200), # Box 7   (9, 1)
    (180, 200, 200, 300), # Box 8   (9, 2)
    (0, 20, 0, 100),      # Box 9   (0, 0)
    (0, 20, 100, 200),    # Box 10  (0, 1)
    (0, 20, 200, 300),    # Box 11  (0, 2)
    (20, 40, 0, 100),     # Box 12  (1, 0)
    (20, 40, 100, 200),   # Box 13  (1, 1)
    (20, 40, 200, 300),   # Box 14  (1, 2)
    (40, 60, 0, 100),     # Box 15  (2, 0)
    (40, 60, 100, 200),   # Box 16  (2, 1)
    (40, 60, 200, 300),   # Box 17  (2, 2)
    (80, 100, 0, 100),    # Box 18  (4, 0)
    (80, 100, 100, 200),  # Box 19  (4, 1)
    (80, 100, 200, 300),  # Box 20  (4, 2)
    (100, 120, 0, 100),   # Box 21  (5, 0)
    (100, 120, 100, 200), # Box 22  (5, 1)
    (100, 120, 200, 300), # Box 23  (5, 2)
    (140, 160, 0, 100),   # Box 24  (7, 0)
    (140, 160, 100, 200), # Box 25  (7, 1)
    (140, 160, 200, 300), # Box 26  (7, 2)
    (160, 180, 0, 100),   # Box 27  (8, 0)
    (160, 180, 100, 200), # Box 28  (8, 1)
    (160, 180, 200, 300), # Box 29  (8, 2)
    (200, 220, 0, 100),   # Box 30  (10, 0)
    (200, 220, 100, 200), # Box 31  (10, 1)
    (200, 220, 200, 300), # Box 32  (10, 2)
    (220, 240, 0, 100),   # Box 33  (11, 0)
    (220, 240, 100, 200), # Box 34  (11, 1)
    (220, 240, 200, 300), # Box 35  (11, 2)
    (240, 260, 0, 100),   # Box 36  (12, 0)
    (240, 260, 100, 200), # Box 37  (12, 1)
    (240, 260, 200, 300), # Box 38  (12, 2)
    (260, 280, 000, 100), #         (13, 0)
    (260, 280, 100, 200), # Box 39  (13, 1)
    (260, 280, 200, 300), #         (13, 2)
]
