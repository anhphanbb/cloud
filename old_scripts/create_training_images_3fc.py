...
csv_file_path = 'cloud_intervals_center_d_60_july_29.csv'
...
def save_radiance_as_images(nc_file_path, orbit_number, cloud_intervals, cloud_chance=0.25, clear_chance=0.06):
