...
model_path = 'models/DeepLearning_resnet_model_3fc.h5'
...
for orbit_number in results:
    ...
    for box_idx in range(3):
        ...
        box_df['Running Average Probability'] = running_avg_probs
        box_df['Running Average Binary Prediction'] = running_avg_binary_pred
        box_df['Filtered Binary Prediction'] = filtered_binary_pred
