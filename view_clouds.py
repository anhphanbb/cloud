...
def update_plot(time_step):
    ...
    # Highlight the boxes where MLCloud is 1
    for box_idx, (x_start, x_end, y_start, y_end) in enumerate(boxes):
        if mlcloud[current_time_step, box_idx] == 1:
            # Create a gray overlay with some transparency
...
ax_button_lines = plt.axes([0.46, 0.15, 0.1, 0.03], facecolor='lightgoldenrodyellow')
